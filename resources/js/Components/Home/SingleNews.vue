        ...
        ()=>{
            switch(props.index){
                case 0:
                    return 'left: 0';
                case 1:
                    return 'left: calc(50% - 14vw);';
                case 2: 
                    return 'left: calc(100% - 28vw)';
                case 3:
                    return 'left: calc(100% - 28vw); transform:translateX(500px); opacity: 0';
                default:
                    return 'left: 0; transform:translateX(-800px); opacity: 0';
            }
        }
    )
